...
static const char __pyx_k_numbRoots[] = "numbRoots_";
...
static const char __pyx_k_numbRoots_2[] = "numbRoots";
...
static int __pyx_pw_16ipTreeStochastic_19PyTreeStochasticSum_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_numbRoots,&__pyx_n_s_types,&__pyx_n_s_checkpoint,&__pyx_n_s_numSamples,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_numbRoots)) != 0)) kw_args--;
        ...
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_checkpoint)) != 0)) kw_args--;
        else {
    ...
    __pyx_v_numbRoots_ = values[0];
    __pyx_v_types_ = values[1];
    __pyx_v_checkpoint_ = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_checkpoint_ == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 27, __pyx_L3_error)
    __pyx_v_numSamples_ = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_numSamples_ == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 27, __pyx_L3_error)
  }
 ...
 */
  ...
  PyTuple_SET_ITEM(__pyx_t_4, 2+__pyx_t_5, __pyx_v_checkpoint);
  __Pyx_INCREF(__pyx_v_numSamples);
  __Pyx_GIVEREF(__pyx_v_numSamples);
  PyTuple_SET_ITEM(__pyx_t_4, 3+__pyx_t_5, __pyx_v_numSamples);
  __Pyx_INCREF(__pyx_v_filename);
  __Pyx_GIVEREF(__pyx_v_filename);
...
static PyObject *__pyx_pw_16ipTreeStochastic_5getApproxSum(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_numbRoots_2,&__pyx_n_s_types_2,&__pyx_n_s_checkpoint_2,&__pyx_n_s_numSamples_2,&__pyx_n_s_filename,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_numbRoots_2)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        case  1:
    ...
    __pyx_v_numbRoots = values[0];
    __pyx_v_types = values[1];
    __pyx_v_checkpoint = values[2];
    __pyx_v_numSamples = values[3];
 ...
 */
  ...
  PyTuple_SET_ITEM(__pyx_t_1, 0, __pyx_v_numbRoots);
  __Pyx_INCREF(__pyx_v_types);
  __Pyx_GIVEREF(__pyx_v_types);
  PyTuple_SET_ITEM(__pyx_t_1, 1, __pyx_v_types);
  __Pyx_INCREF(__pyx_v_checkpoint);
  __Pyx_GIVEREF(__pyx_v_checkpoint);
  PyTuple_SET_ITEM(__pyx_t_1, 2, __pyx_v_checkpoint);
  __Pyx_INCREF(__pyx_v_numSamples);
  __Pyx_GIVEREF(__pyx_v_numSamples);
